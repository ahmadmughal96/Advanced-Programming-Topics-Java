...
public class DeviceResources {
	...
	public Response get(@PathParam("deviceId") long deviceId) {
		...
		deviceDataDTO.setDeviceName("DummyDeviceName");
		deviceDataDTO.setOwner("dummey-owner");
		deviceDataDTO.setPassword("password");
		deviceDataDTO.setLocation("10,4050");
		return Response.ok(deviceDataDTO).build();
